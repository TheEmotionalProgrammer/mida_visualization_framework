...
void Menu::showRayCastTab(std::chrono::duration<double> renderTime)
{
    if (ImGui::BeginTabItem("Raycaster")) {
        ...
        ImGui::RadioButton("DVR to MIDA to MIP", pRenderModeInt, int(render::RenderMode::RenderCombined));
        ...
        ImGui::DragFloat("ka", &m_renderConfig.ka, 0.01f, 0.0f, 1.0f);
        ImGui::DragFloat("kd", &m_renderConfig.kd, 0.01f, 0.0f, 1.0f);
        ImGui::DragFloat("ks", &m_renderConfig.ks, 0.01f, 0.0f, 1.0f);
        ImGui::DragFloat("alpha", &m_renderConfig.alpha, 0.1f, 0.0f, 100.0f);

        ImGui::NewLine();

        ImGui::Checkbox("smoothstep", &m_renderConfig.smoothstep);
        ImGui::DragFloat("gl", &m_renderConfig.gl, 0.005f, 0.0f, 1.0f);
        ImGui::DragFloat("gh", &m_renderConfig.gh, 0.005f, 0.0f, 1.0f);
        ...
        ImGui::DragFloat("gamma", &m_renderConfig.gamma, 0.1f, -1.0f, 1.0f);
